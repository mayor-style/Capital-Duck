    ...
    <section className='How'>
      <div className="HowToPlaySec">
        ...
        <div className="card hidden-How">
          ...
          <h3>For Stakers:</h3>
          <p>- Invest to Begin: Start farming by staking as low as <span style={{fontSize:"18px"}}>$</span>1. This small investment gives you a higher earning speed. The higher the Stake, the higher and faster the earning is!</p> <br />
